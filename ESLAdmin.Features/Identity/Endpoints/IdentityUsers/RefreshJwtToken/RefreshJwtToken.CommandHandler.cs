...
public class RefreshTokenJwtCommandHandler :
  IdentityCommandHandlerBase<RefreshTokenJwtCommandHandler>,
  ICommandHandler<RefreshJwtTokenCommand,
    Results<Ok<RefreshJwtTokenResponse>, 
      ProblemDetails, 
      InternalServerError>>
{
    ...
    ExecuteAsync(RefreshJwtTokenCommand command, CancellationToken ct)
  {
    try
    {
      ...
      var tokenResult = await _repository
